...
from custom_items.losses import decoupl_nt_xent_loss, ml_xent_loss
...
pretrain_model.compile(optimizer=tfa.optimizers.SGDW(weight_decay=1e-6, learning_rate=args.learning_rate * 5, momentum=0.95, nesterov=True),
                       domain_class_loss_fn=ml_xent_loss, sim_loss_fn=decoupl_nt_xent_loss, discriminator=None, domain_class_loss_type='multi-label',
