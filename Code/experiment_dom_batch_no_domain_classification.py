...
from custom_items.pretrain_models import DomPretrainModel
...
pretrain_model = DomPretrainModel(inp, proj, name=args.model_name)
pretrain_model.compile(optimizer=tfa.optimizers.SGDW(weight_decay=1e-6, learning_rate=args.learning_rate * 5, momentum=0.95, nesterov=True),
                       sim_loss_fn=dom_aware_decoupl_nt_xent_loss, tau=args.tau, awareness_type='batch')
# ------------------------------------------------------------------------------------------------------------------
